...
This is an example on how the directory can be structured for a 1:1 (repo-to-single cluster)
git repo for OpenShift.

This example assumes (as mentioned in the 1:1 part above) that it's a
...
This is based on Argo CD.

# Structure

Below is an explanation on how this repo is laid out. [Kustomize](https://kustomize.io/) was used heavily. This is the most efficient way to manage and
...
```shell
until kubectl apply -k https://github.com/example/example-openshift-go-repo/cluster-XXXX/bootstrap/overlays/default; do sleep 3; done
```

This will configure all day-2 configurations with some test application.
